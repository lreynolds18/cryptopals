...
fn main() {
  ...
  println!("Input: 49276d206b696c6c696e6720796f757220627261696e206c696b65206120\
    706f69736f6e6f7573206d757368726f6f6d");

  println!("Ans: SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t");
  println!("Res: {}", set1::hex_to_base64("49276d206b696c6c696e6720796f75722062\
  ...
  println!("Res: {}", set1::fixed_xor("1c0111001f010100061a024b53535009181c", 
    "hex", "686974207468652062756c6c277320657965", "hex"));
  ...
  let (ans_message3, ans_key3) = set1::single_byte_xor_cipher(
    "1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736", "hex");
  ...
  let (ans_message4, ans_key4, ans_line4) = set1::detect_single_character_xor(
    "./set1challenge4.txt");
  ...
  println!("Ans: 0b3637272a2b2e63622c2e69692a23693a2a3c6324202d623d63343c2a2622\
    6324272765272a282b2f20430a652e2c652a3124333a653e2b2027630c692b20283165286326302e27282f");
  
  println!("Res: {}", set1::repeating_key_xor_encrypt("Burning 'em, if you ain't \
    quick and nimble\nI go crazy when I hear a cymbal", "ascii", "ICE", "ascii"));
  ...
  let (ans_message6, ans_key6, ans_keysize6, ans_line6) = 
    set1::break_repeating_key_xor("./set1challenge4.txt");
