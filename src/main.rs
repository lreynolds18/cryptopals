...
fn main() {
  ...
  println!("Res: {}", set1::hex_to_base64("49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d")); 
  println!();
  ...
  println!("Res: {}", set1::fixed_xor(&"1c0111001f010100061a024b53535009181c", &"hex", 
                                      &"686974207468652062756c6c277320657965", &"hex".to_string()));
  println!();
  ...
  let (ans_message3, ans_key3) = set1::single_byte_xor_cipher(&"1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736", &"hex");
  ...
  let (ans_message6, ans_key6, ans_keysize6, ans_line6) = set1::break_repeating_key_xor(&"./set1challenge4.txt");
  println!("Ans message: ?");
